...
public class Add_to_Cart {
	...
	public void add_item_to_cart() {
		...
		String actualPrdPrice = driver.findElement(By.xpath("//a[normalize-space()='" + prdName
				+ "']/parent::td/following-sibling::td//span[@class='product-subtotal']")).getText();
	...
	public void Update_From_Cart() throws InterruptedException {
		...
		String actualSoftName = driver
				.findElement(By.xpath("//a[normalize-space()='" + prdName + "']/parent::td//div[@class='attributes']"))
				.getText();

		// String actualSoftName =
		// driver.findElement(By.xpath("//a[text()='"+prdName+"']/..//div[@class='attributes']")).getText();
