...
public class Extent_Report_Example {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") +"/test-output/IBM_WebOrder_ExtentReport.html");
		//initialize ExtentReports and attach the HtmlReporter
		extent = new ExtentReports();
		extent.attachReporter(htmlReporter);
		//To add system or environment info by using the setSystemInfo method.
		extent.setSystemInfo("OS", System.getProperty("os.name"));
		extent.setSystemInfo("Browser", "Chrome Latest Version");
		extent.setSystemInfo("QA Name", "Deepa");
